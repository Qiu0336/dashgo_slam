...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        pid_params = dict()
        pid_params['wheel_diameter'] = rospy.get_param("~wheel_diameter", 0.1264) 
        pid_params['wheel_track'] = rospy.get_param("~wheel_track", 0.355)
...
class ArduinoROS():
    def __init__(self):
        ...
        self.port = rospy.get_param("~port", "/dev/dashgo")
